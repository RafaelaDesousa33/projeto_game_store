...
Este projeto foi desenvolvido como prática de estudos em desenvolvimento front-end, com foco em estruturação de páginas e estilização de componentes.

Como visualizar o projeto

Clone o repositório:

git clone https://github.com/RafaelaDesousa33/projeto_game_store.git
